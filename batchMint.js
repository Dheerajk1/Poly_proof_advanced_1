// This script batch mints avengers ERC721A tokens.
...
async function main() {
  ...
  const contractAddress = "0x5Bbccf24daCe3549B31855F3D77Ce068F43389f4";

  // Get the contract factory and attach it to the signer
  const IndianNFT = await ethers.getContractFactory("avengers", signer);
